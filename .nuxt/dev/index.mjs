...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, getResponseStatusText } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/@vue/shared/dist/shared.cjs.js';
import Fuse from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/fuse.js/dist/fuse.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/ufo/dist/index.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/nitropack/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/volkanoluc/Projects/eneba/frontend/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/volkanoluc/Projects/eneba/frontend/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/volkanoluc/Projects/eneba/frontend","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/volkanoluc/Projects/eneba/frontend/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/volkanoluc/Projects/eneba/frontend/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/volkanoluc/Projects/eneba/frontend/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/volkanoluc/Projects/eneba/frontend/.data/kv"}));
...
const _4E9Tl1WtfqLjZDGuMPZpAwfLe4PdQKidRqZogoF6uI = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/volkanoluc/Projects/eneba/frontend";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Buy games, gift cards, and more at the best prices"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Eneba - Game Marketplace"};
...
const _bt3jKhe7xwF64QGSUShtJ8vSgIOzOyxpMYdOsAb4pcE = (nitroApp) => {
...
const plugins = [
  _4E9Tl1WtfqLjZDGuMPZpAwfLe4PdQKidRqZogoF6uI,
_bt3jKhe7xwF64QGSUShtJ8vSgIOzOyxpMYdOsAb4pcE
];
...
const _BWGtEk = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/volkanoluc/Projects/eneba/frontend/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/volkanoluc/Projects/eneba/frontend/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_E72bBX = () => Promise.resolve().then(function () { return autocomplete_get$1; });
const _lazy_53LMoR = () => Promise.resolve().then(function () { return _slug__get$1; });
const _lazy_uVqBuT = () => Promise.resolve().then(function () { return list_get$1; });
const _lazy_IQqZEM = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _BWGtEk, lazy: false, middleware: true, method: undefined },
  { route: '/api/autocomplete', handler: _lazy_E72bBX, lazy: true, middleware: false, method: "get" },
  { route: '/api/games/:slug', handler: _lazy_53LMoR, lazy: true, middleware: false, method: "get" },
  { route: '/api/list', handler: _lazy_uVqBuT, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_IQqZEM, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_IQqZEM, lazy: true, middleware: false, method: undefined }
];
...
const platforms = ["Steam", "Xbox", "PlayStation", "Nintendo", "Epic", "Origin", "GOG", "Uplay"];
const regions = ["GLOBAL", "EU", "US", "TR", "UK", "DE", "LATAM", "ASIA"];
const baseGames = [
...
const generatePrice = () => {
  const originalPrice = Math.floor(Math.random() * 60) + 10;
  const hasDiscount = Math.random() > 0.3;
  const discount = hasDiscount ? Math.floor(Math.random() * 50) + 10 : 0;
  const price = hasDiscount ? Math.round(originalPrice * (1 - discount / 100) * 100) / 100 : originalPrice;
  return { price, originalPrice, discount };
};
const generateImage = (id, title) => {
...
const generateGames = () => {
  ...
  const subscriptions = [
    { name: "Xbox Game Pass Ultimate", platform: "Xbox", months: [1, 3, 12] },
    { name: "PlayStation Plus Premium", platform: "PlayStation", months: [1, 3, 12] },
    { name: "Nintendo Switch Online", platform: "Nintendo", months: [3, 12] },
    { name: "EA Play", platform: "Origin", months: [1, 12] }
  ];
...
const autocomplete_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: autocomplete_get
}, Symbol.toStringTag, { value: 'Module' }));
